...
> **Warning**  
> Cashier Paddle 1.x and this documentation are for Paddle Classic. If you want to use Paddle's new Paddle Billing product, check out [the latest release of Cashier Paddle](https://github.com/presttec/laravel-cashier-paddle).
...
```shell
composer require presttec/laravel-cashier-paddle
```
